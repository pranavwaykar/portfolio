  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
        <path
          fill="#e74c3c"
          d="M12 13.065 2.4 6.6A2 2 0 0 1 4 4h16a2 2 0 0 1 1.6 2.6l-9.6 6.465Zm9.6-4.53V18a2 2 0 0 1-2 2H4.4a2 2 0 0 1-2-2V8.535l9.6 6.465 9.6-6.465Z"
        />
      </svg>
    ),
  },
...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const handleEnter = () => {
      ...
      gsap.to(border, {
        background:
          "conic-gradient(from 180deg, #162447 0deg, #1a2240 90deg, #23214a 180deg, #3a1a3a 270deg, #162447 360deg)",
        scale: 1.05,
        duration: 0.4,
        ease: "power2.out",
      });
    ...
    const handleLeave = () => {
      ...
      gsap.to(border, {
        background:
          "conic-gradient(from 180deg, #162447 0deg, #b31217 180deg, #162447 360deg)",
        scale: 1,
        duration: 0.6,
        ease: "elastic.out(1,0.5)",
      });
      ...
      <div className="hero__wrapper">
        ...
        <div className="hero__content" ref={contentRef}>
          <h1 className="hero__title">
            Hi, I'm <span className="hero__highlight">Pranav Waykar</span>
          </h1>
          ...
          <div className="contact-button-wrapper">
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1wVPHbhiYWQ2VyKlm3kvgGNDT66Ya4JvC/view?usp=sharing",
                  "_blank",
                  "noopener,noreferrer"
                )
              }
